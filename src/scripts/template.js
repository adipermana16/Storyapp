...
export function generateAuthenticatedNavigationListTemplate() {
  return `
        <li> <a id="home-button" class="btn home-button" href="#/">Home</a></li>
        <li id="push-notification-tools" class="push-notification-tools"></li>
        <li> <a id="bookmark-button" class="btn bookmark-button" href="#/bookmark">Story Tersimpan</a></li>
        <li> <a id="new-story-button" class="btn new-story-button" href="#/add">Add Story</a></li>
...
export function generateStoriesListErrorTemplate(message) {
  return `
        <div id="stories-list-error" class="stories-list__error">
          ...
          <p>${message ? message : "Gunakan jaringan lain atau laporkan error ini."
    }</p>
        </div>
    `;
}
            ...
            <div class="story-item__main">
              ...
              <div class="story-item__more-info">
                ...
                <div class="story-item__location">
                  ${location.latitude ?? "Tidak ada data"}, ${location.longitude ?? "Tidak ada data"
    }
                </div>
              </div>
            </div>
        ...
        <div class="container">
            <div class="story-detail__body">
                <div class="story-detail__more-info">
                    ...
                    <div class="story-detail__more-info__inline">
                      <div id="location-latitude" class="story-detail__location__latitude" data-value="${location.latitude ?? "Latitude tidak ada"
    }">Latitude:</div>
                      <div id="location-longitude" class="story-detail__location__longitude" data-value="${location.longitude ?? "Longitude tidak ada"
    }">Longitude:</div>
                    </div>
